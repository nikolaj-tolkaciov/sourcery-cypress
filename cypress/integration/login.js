...
import TimeLoginPage from '../objects/TimeLogginPage/timeLogging'

const loginPage = new LoginPage()
const timeLoginPage = new TimeLoginPage()
const testUser = 'Nadežda Žarikova'
...
for (let role of rolesArray) {
   it('Should be able to login with different Roles', function () {
       ...
       timeLoginPage.currentDay().contains(new Date().getDate())
